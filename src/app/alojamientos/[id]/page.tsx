      ...
      <section ref={containerRef} className="relative h-[60vh] md:h-[75vh] w-full overflow-hidden flex items-end">
        ...
        <div className="relative z-20 w-full p-8 md:p-20 text-white container mx-auto">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-6 text-xl md:text-2xl font-light">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg opacity-60">({accommodation.reviews} reseñas)</span>
              </div>
            </div>
          </motion.div>
        </div>
            ...
            <Card className="border-none shadow-[0_40px_100px_rgba(0,0,0,0.08)] rounded-[3rem] overflow-hidden bg-white/80 backdrop-blur-xl">
              <CardContent className="p-10 md:p-16">
                ...
                <div className="space-y-6 text-slate-600 mb-12">
                  <h3 className="text-3xl font-black text-slate-900 tracking-tight">Sobre este alojamiento</h3>
                  <p className="text-xl leading-relaxed font-light">{accommodation.description}</p>
                </div>

                <div className="space-y-6 pt-12 border-t border-slate-100">
                  <h3 className="text-2xl font-black text-slate-900 tracking-tight">Servicios Incluidos</h3>
            ...
            <Card className="border-none shadow-[0_40px_100px_rgba(0,0,0,0.12)] rounded-[2.5rem] overflow-hidden bg-white">
              <CardHeader className="bg-slate-50 p-10 border-b border-slate-100">
                <CardTitle className="flex justify-between items-end">
                  <span className="text-5xl font-black text-slate-900 tracking-tighter">{accommodation.price}</span>
                  <span className="text-lg text-slate-400 font-medium mb-1">/ noche</span>
                </CardTitle>
              ...
              <CardContent className="p-10 space-y-8">
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button asChild className="w-full bg-green-600 hover:bg-green-700 text-white shadow-2xl shadow-green-200 text-xl h-20 rounded-full font-black">
            ...
            <Card className="mt-8 border-none shadow-2xl bg-slate-950 text-white rounded-[2.5rem] overflow-hidden relative group">
              ...
              <CardContent className="p-10 pt-0 space-y-10 relative z-10">
                <div className="space-y-2">
                  ...
                  <div className="text-3xl font-black text-white tracking-tighter">{accommodation.logistics.distanceToTermas}</div>
                </div>
